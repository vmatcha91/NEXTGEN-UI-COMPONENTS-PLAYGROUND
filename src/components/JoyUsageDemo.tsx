...
function createCode(
  ...
  let code = `<${name}`;
  const props = Object.entries(inProps).sort((a, b) =>
...
export default function JoyUsageDemo<T extends { [k: string]: any } = {}>({
  ...
  return (
    ...
    >
      ...
      >
        <Box
          sx={{ flexGrow: 1, m: "auto", display: "flex", alignItems: "center" }}
        >
      ...
      >
        ...
        >
          ...
          <IconButton
            ...
            sx={{
              visibility: !shallowEqual(props, initialProps)
                ? "visible"
                : "hidden",
            ...
            ({
              ...
              if (knob === "switch") {
                return (
                  ...
                  >
                    <FormLabel sx={{ textTransform: "capitalize", mb: 0 }}>
                      {formLabel}
                    </FormLabel>
                    <Switch
